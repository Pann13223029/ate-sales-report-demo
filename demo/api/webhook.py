...
อัพเดทดีลเดิม:
• พิมพ์: อัพเดท MSG-XXXXXXXX ตามด้วยข้อมูลใหม่
• ตัวอย่าง: อัพเดท MSG-A1B2C3D4 สถานะเจรจา ราคา 2.8 ล้าน
...
ใช้ Batch ID (MSG-XXXXXXXX) ที่ได้ตอนรายงาน:

พิมพ์: อัพเดท MSG-XXXXXXXX ตามด้วยข้อมูลใหม่

ตัวอย่าง:
• อัพเดท MSG-A1B2C3D4 สถานะเจรจา ราคา 2.8 ล้าน
• อัพเดท MSG-A1B2C3D4 ปิดดีลได้แล้ว วางมัดจำ 50%
• อัพเดท MSG-A1B2C3D4 เสียงาน ลูกค้าตัดงบ
• อัพเดท MSG-A1B2C3D4 นัดเยี่ยมอังคารหน้า
...
# ---------------------------------------------------------------------------
# Update existing entries: อัพเดท MSG-XXXXXXXX
# ---------------------------------------------------------------------------
...
def handle_update_command(message_text, reply_token, rep_name, user_id=""):
    """Handle 'อัพเดท MSG-XXXXXXXX ...' command. Returns True if handled."""
...
class handler(BaseHTTPRequestHandler):
    ...
    def _process_event(self, event: dict):
        ...
        # Check for update command: อัพเดท MSG-XXXXXXXX ...
